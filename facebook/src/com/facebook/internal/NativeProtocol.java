...
public final class NativeProtocol {
    ...
    public static Exception getErrorFromResult(Bundle errorBundle) {
        // TO DO This is not going to work for JS dialogs, where the keys are not STATUS_ERROR_TYPE etc.
        // TO DO However, it should keep existing dialogs functional
        ...
        /* TO DO parse error values and create appropriate exception class */
